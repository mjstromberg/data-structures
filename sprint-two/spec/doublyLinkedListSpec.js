describe('doublyLinkedList', function() {
  ...
  it('should have a tail node that has a tail property of null', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
    expect(doublyLinkedList.tail.next).to.equal(null);
  });

  it('should link each node to its previous node', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
    expect(doublyLinkedList.tail.previous).to.equal(4);
  });

  it('should have a head node with a previous property of null', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
